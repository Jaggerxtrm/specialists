...
export function createResumeSpecialistTool(registry) {
    return {
        name: 'resume_specialist',
        description: 'Resume a waiting keep-alive specialist session with a next-turn prompt. ' +
...
//# sourceMappingURL=resume_specialist.tool.js.map