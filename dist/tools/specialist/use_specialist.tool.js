...
export function createUseSpecialistTool(runner) {
    return {
        name: 'use_specialist',
        description: 'Run a specialist synchronously and wait for the result. ' +
...
//# sourceMappingURL=use_specialist.tool.js.map