...
export function loadMandatoryRulesIndex(cwd) {
...
export function buildMandatoryRulesInjection(specialistConfig) {
...
export function buildMandatoryRulesBlock(specialistConfig) {
    return buildMandatoryRulesInjection(specialistConfig).block;
}
//# sourceMappingURL=mandatory-rules.js.map