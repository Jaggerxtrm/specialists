# Archived Specialists roadmap v3.2

> **Historical record only.** This file preserves the complete pre-v3.3 critique, friction catalog, opportunity set, rollout, chain-template discussion, and decision log as it existed at commit `eaf044f0`. It is not an executable plan. Current authority and sequence live in [`../specialists-roadmap.md`](../specialists-roadmap.md).
