...
| Section | Summary |
|---|---|
| [Current specialists](#current-specialists) | | Name | Typical use | (14 specialists) |
| [Project-only scope](#project-only-scope) | This repo now teaches a project-only model for specialist discovery |
