...
const CORE_COMMANDS: CommandEntry[] = [
  ...
  ['node', 'NodeSupervisor control plane: run/list/status/feed/promote/members/memory/steer/stop/attach'],
...
export async function run(): Promise<void> {
  ...
  '  Output modes',
    ...
    '  specialists run debugger --bead unitAI-123 --context-depth 2',
    '  specialists node run research --bead unitAI-3f7b --context-depth 2',
    '  specialists node members research-ab12cd34 --json',
    ...
    '  specialists node --help         Node run/control and inspection details',
    '',
