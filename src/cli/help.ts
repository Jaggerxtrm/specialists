...
const CORE_COMMANDS: CommandEntry[] = [
  ...
  ['epic', 'Epic lifecycle management: list/status/resolve/recover for wave-bound chain groups'],
  ...
  ['epic recover', 'Recovery-first active epic reconstruction after compaction/context loss'],
...
export async function run(): Promise<void> {
  ...
  '  Output modes',
    ...
    '  specialists epic recover --json                 # compaction recovery payload',
