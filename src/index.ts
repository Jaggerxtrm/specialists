  ...
  if (sub === 'render-task') {
    if (wantsHelp()) {
      console.log([
        ...
        '                         experimental until GATE-IFACE (K5). Launch, worktree and',
        '                         structured outcome stay Core-owned (K2 boundary).',
        '',
  ...
  if (sub === 'render-bead') {
    if (wantsHelp()) {
      console.log([
        ...
        '                         codex is experimental until GATE-IFACE (K5).',
        '',
  ...
  if (sub === 'view') {
    if (wantsHelp()) {
      console.log([
        ...
        '                         (pi, claude, or codex — codex experimental until GATE-IFACE/K5)',
