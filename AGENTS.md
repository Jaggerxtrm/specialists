...
This project is indexed by GitNexus as **specialists** (2032 symbols, 4197 relationships, 169 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
