...
This project is indexed by GitNexus as **specialists** (3712 symbols, 8494 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
