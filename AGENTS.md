...
This project is indexed by GitNexus as **specialists** (4384 symbols, 9552 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
