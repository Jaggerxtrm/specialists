...
This project is indexed by GitNexus as **specialists** (8743 symbols, 19756 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
