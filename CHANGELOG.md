...
### Added
- Active-tool advisory startup context (unitAI-kaae7) ([a7d057a](https://github.com/xtrm-dev/specialists/commit/a7d057ad21d6b3dc9236a356f3265b7acfc7b0f0))
- Global mandatory-rules template_sets selection (unitAI-klo6k) ([84d1c73](https://github.com/xtrm-dev/specialists/commit/84d1c73edcecdd7aca97ec716baafd80bc934f0e))
- Resolve bare project-pack skills in runtime (unitAI-jndsb.11) ([07319de](https://github.com/xtrm-dev/specialists/commit/07319dea06653bd8494e23fef1679fe8246a57fe))
- Bind service knowledge sync to project pack (unitAI-jndsb.12) ([3e74ef4](https://github.com/xtrm-dev/specialists/commit/3e74ef4cd0415bd36df97b120e645c5b89c61b19))
- Integrate project-pack service knowledge ([d97dea8](https://github.com/xtrm-dev/specialists/commit/d97dea89b8889210f13bf84a8daa919d93a0eae5))

### Fixed
- Repair bun observability baseline gate ([7fc338c](https://github.com/xtrm-dev/specialists/commit/7fc338c179676958b57f769f76963bead802ce99))
- Prevent forensic event seq overwrite ([8506cbf](https://github.com/xtrm-dev/specialists/commit/8506cbfa3f4f9ad4e8a42f37f6b295691d071852))
- Expose enabled-extension tools via deny-list tool gate (unitAI-34pyf) ([a811233](https://github.com/xtrm-dev/specialists/commit/a811233498c157b71c5e721593f9a35c7633fad2))
- Fail-closed extension tool-policy gate (unitAI-34pyf security rework) ([56c9472](https://github.com/xtrm-dev/specialists/commit/56c9472ab8bfd86407fa6bc0457f125aede76062))
- Hard-fail policy gate, dead dist removal, raw-spawn assertion (unitAI-34pyf audit round 2) ([c924d59](https://github.com/xtrm-dev/specialists/commit/c924d59fbb98f6707a723ef75f2ae96588982a68))
- Never emit unresolved template placeholders ([33e6b1e](https://github.com/xtrm-dev/specialists/commit/33e6b1e03327a6cb9f853f7603c60369a41a2e17))
- Reject pending RPC immediately when pi child exits (unitAI-u5xjk) ([27b9d62](https://github.com/xtrm-dev/specialists/commit/27b9d62f06f8588ca67fac2554f4b768df52629e))
- Validate global template_sets before list-rules overlay (unitAI-klo6k seconder) ([96ce652](https://github.com/xtrm-dev/specialists/commit/96ce652fea2314b7abe254f717917e6d2dd6a889))
- Path-containment for mandatory-rules set ids (unitAI-klo6k security F2) ([706d551](https://github.com/xtrm-dev/specialists/commit/706d55181a36564297555f6f782d11012bd42aa1))
- Kebab-harden template_sets at merge (unitAI-klo6k security F1) ([bfbccb1](https://github.com/xtrm-dev/specialists/commit/bfbccb15d04dfce6c79bd2991cf5c7d4e42f5976))
- List-rules true layered merge and runtime-parity defaults (unitAI-klo6k F2/F4) ([aabb927](https://github.com/xtrm-dev/specialists/commit/aabb927ddb29a127c1d6b9be9ac85d265048d8dd))
- Doctor survives malformed global user.json (unitAI-klo6k final reviewer) ([acc7900](https://github.com/xtrm-dev/specialists/commit/acc79008a5997725cc802546d43ad163a7f18fe5))
- Bound real service preflight output (unitAI-p9wo2) ([247f8bc](https://github.com/xtrm-dev/specialists/commit/247f8bc3837bc00bed2563583d74b8f1fca9ae66))
- Preserve preflight semantics ([aad7995](https://github.com/xtrm-dev/specialists/commit/aad79956c6b7dc01f9c4302a9b2455334c35f489))
- Harden direct skill trust ([033406a](https://github.com/xtrm-dev/specialists/commit/033406af527a370cadea30fb588d0c48782d2725))
...
- Remove retired loose service-skills injections ([976cbd4](https://github.com/xtrm-dev/specialists/commit/976cbd40f2634e45c88924bf7cf37176d04f58eb))
- Put exact bead id in every turn-1 initial prompt (unitAI-edfjs) ([d6a8418](https://github.com/xtrm-dev/specialists/commit/d6a841895cf0648731911e7139c0529ac33d0e1a))
...
- Finish extension integration coverage ([480f89e](https://github.com/xtrm-dev/specialists/commit/480f89ed2e1f304af332e816fe086a1315bef2f2))
- Rebuild 3.21.6 RC artifacts ([b6989ce](https://github.com/xtrm-dev/specialists/commit/b6989cea9f46e6d3cb614273f4e9722fb868c5b6))
- Rebuild 3.21.6 artifacts after final extension fixes (unitAI-1d6ui) ([1f68d66](https://github.com/xtrm-dev/specialists/commit/1f68d6650430cde016b1db1a3eb5883ee922082d))
- Rebuild 3.21.6 artifacts after RPC fail-fast fix (unitAI-wuing) ([a97c06e](https://github.com/xtrm-dev/specialists/commit/a97c06e80bc38f37543fdd918b1cafef4c2eb697))
- Repo-overlay authority nuance for mandatory-rules (unitAI-klo6k test-runner F1) ([0ae676f](https://github.com/xtrm-dev/specialists/commit/0ae676fb429af9103b61d733e483644a8ab77d02))
