...
Installa: `@mariozechner/pi-coding-agent`, `@beads/bd`, dolt (sudo interattivo su Linux / brew su macOS), `@jaggerxtrm/specialists` globalmente, registra MCP come `specialists` a scope user, scaffolda `~/.agents/specialists/`.
